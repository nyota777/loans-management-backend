import { z } from "zod";
import { createPayment, confirmPayment, getPaymentsByLoanId, getPaymentsByMemberId, getAllPayments, } from "../services/payments.service.js";
...
export async function getByLoanId(req, res) {
    const payments = await getPaymentsByLoanId(req.params.loanId);
    res.status(200).json(payments);
}
export async function getByMemberId(req, res) {
