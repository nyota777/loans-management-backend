...
function getDueDateForInstallment(loanStartDate, installmentNumber) {
...
export async function confirmPayment(id, adminId, referenceCode) {
    ...
    if (finalRefCode && finalRefCode !== payment.referenceCode) {
        ...
        if (existing)
            throw new Error("Reference code already used");
    }
